  ...
  return (
    <div className='relative w-full flex flex-col items-center justify-center'>
      ...
      <div className='w-full flex flex-col items-center justify-center text-black'>
        ...
        <p className='md:w-[60%] text-[16px] md:text-[20px] lg:text-[20px] xl:text-[24px]'>Alver Power Systems is a leading company specializing in switchboard manufacturing, 
