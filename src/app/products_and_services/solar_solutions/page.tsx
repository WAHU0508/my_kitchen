                ...
                <div className="px-6 py-12 bg-white text-gray-900">
                  <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl mb-10 text-gray-700">
                      At <span className="font-semibold">[Your Company Name]</span>, we provide clean, reliable, and customized solar energy solutions that empower homes, businesses, and communities.
                    </p>
