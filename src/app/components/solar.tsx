...
export default function Product1() {
  return (
    <div className="relative w-[320px] h-[200px] group overflow-hidden">
      <Image 
        src={solarimg}
        alt="Solar Img"
        fill
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-transparent group-hover:bg-black/60 transition-colors duration-300 flex flex-col">
        <div className="ml-[50px] mt-[100px] mb-4 flex flex-col gap-3">
          ...
          <button className='px-1 py-2 border border-white text-[16px] text-white active:bg-white active:text-black opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out'>
            See More
          </button>
        </div>
      </div>
