        ...
        <header className='w-full mb-4 flex items-center justify-center'>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex">
                    ...
                    <div
                        className={`fixed left-0 top-0 h-screen w-[262px] flex flex-col items-center justify-between bg-white shadow-xl z-50 transition-transform duration-300 transform ${
                    ...
                    >
                        ...
                        {/* Footer section */}
                        <div className='flex flex-col items-center gap-[20px] w-full h-[450px] text-white bg-[#252865] py-2'>
                            {/* Operating Hours Section */}
                            <div className='w-[193px] h-[150px] flex flex-col items-center justify-between'>
                            ...
                            {/* Location section */}
                            <div className='w-[232px] h-[50px] flex flex-col items-center justify-between'>
                                <Image
                                    src={mapPin}
                                    width={24}
                                    height={24}
                            ...
                            <div className='w-[186px] h-[100px] flex flex-col items-center justify-between'>
