...
export default function Header() {
    ...
    return (
        <header className='w-full mb-4 flex items-center justify-center'>
            ...
            <div className='hidden border border-[#0000003D] bg-[#FFFFFF] lg:flex lg:flex-row md:flex md:flex-row items-center justify-between px-10 lg:w-[90%] xl:w-[90%] 2xl:w-[90%] md:w-full py-4 shadow-xl rounded-[5px]'>
                <Image
                    src={logo}
                    width={150}
                    height={45}
