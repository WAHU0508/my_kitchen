...
export default function Header() {
    ...
    return (
        <header className='w-full mb-4 flex items-center justify-center'>
            ...
            <div className='hidden border border-[#0000003D] bg-[#FFFFFF] lg:flex lg:flex-row md:flex md:flex-row items-center justify-between px-10 lg:w-[1250px] md:w-full lg:h-[50px] md:h-[50px] shadow-xl rounded-[5px]'>
                <Image
                    src={logo}
                    width={150}
                    height={45}
                ...
                <div className='flex flex-row gap-6 h-full text-[15px] text-black items-center justify-center'>
                    <Link
                          href="/"
                          className={`border border-black h-full flex items-center justify-center font-semibold cursor-pointer hover:text-[#252865] hover:underline ${
                            pathname === '/' ? 'text-[#FF0105]' : 'text-black'
                          }`}
                        >
                          Home
                    </Link>
