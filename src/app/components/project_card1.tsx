...
export default function ProjectCard() {
  return (
    <div className='relative w-[300px] h-[259px] lg:w-[386px] lg:h-[379px] bg-[rgba(50,101,37,0.47)] opacity-[0.37] border border-[#D9D9D9] shadow-[0px_4px_4px_5px_rgba(0,0,0,0.25)]'>
      ...
      <div className='flex flex-row gap-2'>
        ...
        <div className="w-[158.15px] h-0 left-[20px] lg:left-[34.92px] top-[60px] border-t-[5px] border-[#252865]"></div>
      </div>
    </div>
  )
}
