    ...
    <section className=' w-full flex flex-col items-center justify-center overflow-x-hidden'> 
      ...
      <div className='lg:p-4 md:p-2 p-1 lg:w-[1300px] md:w-full w-full flex flex-col'>  
        ...
        <div className='w-full flex flex-row items-center justify-center lg:gap-[200px] md:gap-[150px] gap-[50px] mt-[20px]'>
          {/*Button 1*/}
          <div className="relative w-[145px] h-[30px] lg:w-[200px] lg:h-[46px] md:w-[200px] md:h-[46px]">
            ...
            <button className="absolute text-black hover:bg-[#252865] hover:text-white active:bg-[#252865] active:text-white w-[145px] h-[30px] lg:w-[200px] lg:h-[46px] md:w-[200px] md:h-[46px] text-[10px] lg:text-[16px] md:text-[16px] inset-0 border-[2px] border-[#252865] rounded-[15px] flex flex-row items-center justify-center lg:items-center lg:justify-center md:items-center md:justify-center gap-2 lg:gap-2 md:gap-2"
