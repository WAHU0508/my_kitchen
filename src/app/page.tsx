...
We specialize in high-quality electrical installations, solar energy solutions and custom switchboard manufacturing. We also offer end to end services that include engineering, procurement, construction (EPC) and maintenance.
        ...
        <div className='flex flex-col mt-[40px]'>
          ...
          <div className='flex flex-col mt-[40px]'>
            ...
            <div className='overflow-x-auto whitespace-nowrap lg:whitespace-normal w-full lg:overflow-x-hidden grid grid-cols-1 lg:grid md:grid lg:grid-cols-3 md:grid-cols-3 gap-4 items-center justify-center'>
              <ProductCard1 />
              <ProductCard2 />
              <ProductCard3 />
            </div>
