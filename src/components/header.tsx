...
export default function Header() {
  ...
  return (
    <header className={`w-full relative hover:bg-white hover:text-black flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      ...
      <div
        className={`hidden w-full md:flex md:flex-row items-center justify-between lg:px-8 h-[60px] sticky top-0 z-50 transition-all duration-500 ease-in-out 
          ${isScrolled ? 'bg-black/60 text-white hover:bg-white hover:text-black' : 'hover:bg-white hover:text-black'} 
