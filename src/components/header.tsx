...
export default function Header() {
  ...
  return (
    <header className={`w-full relative bg-white hover:bg-white hover:text-black flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
